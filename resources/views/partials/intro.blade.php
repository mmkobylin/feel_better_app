...
<section>
    <h3>My first goal with this app is to try my best to help anyone in a dark place. (cause I've been there). <br>
        For that go to <a class="nav" href="/lightbringer">LIGHTBRINGER</a>
    </h3>
...
<section>
    ...
    <h3> My second goal is to help people to step up their game after they got better! Now when you feel better, you might want to stretch yourself little further.<br>
        <br>For that go to <a class="nav" href="/heavylifter">HEAVYLIFTER</a>.
    </h3>
    ...
    <p id="paragraph2" style="display: none">
        ...
        This is what I created a <a class="nav" href="/heavylifter">HEAVYLIFTER</a> for. <br>
